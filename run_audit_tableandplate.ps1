$baseDir = "d:\antigravity website\tableandplate"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "    TABLEANDPLATE - AUDIT REPORT         " -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
if ($indexContent -match "blog-plate-card" -or $indexContent -match "blog-plate-grid") {
...
Write-Host "`nTableAndPlate Audit Completed Successfully." -ForegroundColor Cyan